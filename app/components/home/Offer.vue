...
<template>
  <div
    class="z-0 flex max-h-350 min-h-150 w-full max-w-415 flex-col items-center justify-center gap-7 p-4 text-black lg:min-h-300 lg:p-12 xl:p-14"
  >
    <div
    ...
    <div
      class="flex max-w-180 justify-center text-center text-[19px] leading-none text-black/90 max-xl:max-w-130 max-xl:text-sm"
    >
    ...
    <div class="flex h-full w-full max-w-315 items-baseline-last gap-2 pt-14">
      <div
